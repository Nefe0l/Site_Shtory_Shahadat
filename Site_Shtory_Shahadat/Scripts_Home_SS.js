window.addEventListener("scroll", function () {
  ...
  let For_Burger_Button = document.querySelector(".Need_3");
  let For_Burger_Menu = document.querySelector(".Burger_Menu");
  let For_Burger_Menu_A = document.querySelector("nav");
 
  For_Burger_Button.onclick = function () {
  For_Burger_Button.classList.toggle("active_B")
  For_Burger_Menu.classList.toggle("active_BM")
  For_Burger_Menu_A.classList.toggle('active_A')
}
